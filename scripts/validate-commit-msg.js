...
let IGNORED = new RegExp(util.format('(^WIP)|(^v)|(^%s$)', semverRegex().source))
...
let error = function() {
  ...
  console.log(
    'See our specific at:',
    'https://github.com/alibaba/wwform/blob/master/.github/GIT_COMMIT_SPECIFIC.md'
  )
}
